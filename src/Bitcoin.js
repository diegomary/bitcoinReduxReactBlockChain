...
class Bitcoin extends Component {
  ...
  componentDidMount(){ this.storeUnsubscribe =  this.context.store.subscribe(this.observeTheStateChanging); };
  ...
  merkle =() =>{
    ...
    alert(merkle(this.t1));
    alert(merkle(this.t2));
  ...
  render() {
    return (
      <div className="App">
        ...
        <p></p>
        <button onClick = {this.merkle}>Calculate Bitcoin Merkle tree</button>
        <p></p>
